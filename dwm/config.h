...
static const char *fonts[]          = { "FiraMono Nerd Font Mono:style=Medium,Regular", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
static char dmenufont[]             = "FiraMono Nerd Font Mono:style=Medium,Regular";
